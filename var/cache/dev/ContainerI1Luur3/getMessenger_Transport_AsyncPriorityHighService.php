...
class getMessenger_Transport_AsyncPriorityHighService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.async_priority_high'])) {
            return $container->privates['messenger.transport.async_priority_high'];
        }

        return $container->privates['messenger.transport.async_priority_high'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN'), ['exchange' => ['name' => 'high'], 'queues' => ['messages_high' => NULL], 'transport_name' => 'async_priority_high'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
