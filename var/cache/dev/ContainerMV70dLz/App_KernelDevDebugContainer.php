...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\GetRssController' => 'getGetRssControllerService',
            'App\\Controller\\SourceController' => 'getSourceControllerService',
            'App\\Controller\\SourceLevelController' => 'getSourceLevelControllerService',
            'App\\Service\\XmlReader' => 'getXmlReaderService',
            'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController' => 'getProfilerControllerService',
            'Dukecity\\CommandSchedulerBundle\\Command\\AddCommand' => 'getAddCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\DisableCommand' => 'getDisableCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\ExecuteCommand' => 'getExecuteCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\ListCommand' => 'getListCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\MonitorCommand' => 'getMonitorCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\RemoveCommand' => 'getRemoveCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\StartSchedulerCommand' => 'getStartSchedulerCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\StopSchedulerCommand' => 'getStopSchedulerCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\TestCommand' => 'getTestCommandService',
            'Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand' => 'getUnlockCommandService',
            ...
            'Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber' => 'getSchedulerCommandSubscriberService',
            'Dukecity\\CommandSchedulerBundle\\Form\\Type\\CommandChoiceType' => 'getCommandChoiceTypeService',
            'Dukecity\\CommandSchedulerBundle\\Service\\CommandParser' => 'getCommandParserService',
            'Dukecity\\CommandSchedulerBundle\\Service\\CommandSchedulerExecution' => 'getCommandSchedulerExecutionService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $a->pushHandler(($container->privates['monolog.handler.buffered'] ?? self::getMonolog_Handler_BufferedService($container)));
        ...
        $e->registerBus('command_bus', ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rgkTZMOMTW', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kHuQvy7zdH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AFL-KcFPCP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1X0JGyVbd2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $c->pushHandler(($container->privates['monolog.handler.chromephp'] ?? self::getMonolog_Handler_ChromephpService($container)));
        $c->pushHandler(($container->privates['monolog.handler.buffered'] ?? self::getMonolog_Handler_BufferedService($container)));
        ...
        $b->setSchemaAssetsFilter(new \Doctrine\Bundle\DoctrineBundle\Dbal\SchemaAssetsFilterManager([new \Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter('~^(?!messenger_messages)~')]));
        $b->setMiddlewares([new \Doctrine\DBAL\Logging\Middleware($c), $d]);

        $container->services['doctrine.dbal.default_connection'] = $instance = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([], new \Doctrine\DBAL\Tools\DsnParser(['db2' => 'ibm_db2', 'mssql' => 'pdo_sqlsrv', 'mysql' => 'pdo_mysql', 'mysql2' => 'pdo_mysql', 'postgres' => 'pdo_pgsql', 'postgresql' => 'pdo_pgsql', 'pgsql' => 'pdo_pgsql', 'sqlite' => 'pdo_sqlite', 'sqlite3' => 'pdo_sqlite'])))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'url' => $container->getEnv('resolve:DATABASE_URL'), 'use_savepoints' => true, 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => $container->getEnv('resolve:MYSQL_VERSION'), 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], $b, $a, []);
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/vendor/dukecity/command-scheduler-bundle/Entity')], true));

        $b->addDriver($c, 'App\\Entity');
        $b->addDriver($c, 'Dukecity\\CommandSchedulerBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/vendor/dukecity/command-scheduler-bundle/Entity')]), 'Dukecity\\CommandSchedulerBundle\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\SourceLevelRepository' => ['privates', 'App\\Repository\\SourceLevelRepository', 'getSourceLevelRepositoryService', true],
            ...
            'App\\Repository\\SourceLevelRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Dukecity\\CommandSchedulerBundle\\Event\\SchedulerCommandCreatedEvent', [#[\Closure(name: 'Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber')] fn () => ($container->services['Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber'] ?? $container->load('getSchedulerCommandSubscriberService')), 'onScheduledCommandCreated'], -10);
        $instance->addListener('Dukecity\\CommandSchedulerBundle\\Event\\SchedulerCommandFailedEvent', [#[\Closure(name: 'Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber')] fn () => ($container->services['Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber'] ?? $container->load('getSchedulerCommandSubscriberService')), 'onScheduledCommandFailed'], 20);
        $instance->addListener('Dukecity\\CommandSchedulerBundle\\Event\\SchedulerCommandPreExecutionEvent', [#[\Closure(name: 'Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber')] fn () => ($container->services['Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber'] ?? $container->load('getSchedulerCommandSubscriberService')), 'onScheduledCommandPreExecution'], 10);
        $instance->addListener('Dukecity\\CommandSchedulerBundle\\Event\\SchedulerCommandPostExecutionEvent', [#[\Closure(name: 'Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber')] fn () => ($container->services['Dukecity\\CommandSchedulerBundle\\EventSubscriber\\SchedulerCommandSubscriber'] ?? $container->load('getSchedulerCommandSubscriberService')), 'onScheduledCommandPostExecution'], 30);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\DocumentController', 'App\\Controller\\GetRssController', 'App\\Controller\\SourceController', 'App\\Controller\\SourceLevelController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController', 'Dukecity\\CommandSchedulerBundle\\Controller\\DetailController', 'Dukecity\\CommandSchedulerBundle\\Controller\\ListController', 'Dukecity\\CommandSchedulerBundle\\Controller\\ApiController', 'Dukecity\\CommandSchedulerBundle\\Entity\\ScheduledCommand']);
    ...
    protected static function getMessenger_DefaultBusService($container)
    {
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\TraceableMessageBus(new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['command_bus.middleware.traceable'] ?? $container->load('getCommandBus_Middleware_TraceableService'));
            yield 1 => ($container->privates['command_bus.middleware.add_bus_name_stamp_middleware'] ??= new \Symfony\Component\Messenger\Middleware\AddBusNameStampMiddleware('command_bus'));
            ...
            yield 5 => ($container->privates['command_bus.middleware.doctrine_ping_connection'] ?? $container->load('getCommandBus_Middleware_DoctrinePingConnectionService'));
            yield 6 => ($container->privates['command_bus.middleware.doctrine_close_connection'] ?? $container->load('getCommandBus_Middleware_DoctrineCloseConnectionService'));
            yield 7 => ($container->privates['command_bus.middleware.send_message'] ?? $container->load('getCommandBus_Middleware_SendMessageService'));
            yield 8 => ($container->privates['command_bus.middleware.handle_message'] ?? $container->load('getCommandBus_Middleware_HandleMessageService'));
        }, 9)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JvoYCVytbg', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pRNYniCIXz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QHoReh0nCK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oDGRfASe3d', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nnQXB1Fh8W', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
     ...
     */
    protected static function getMonolog_Handler_BufferedService($container)
    {
        $a = new \Systemsdk\Bundle\EasyLogBundle\Handler\EasyLogHandler((\dirname(__DIR__, 3).'/log/dev-readable.log'));
        $a->setFormatter(new \Systemsdk\Bundle\EasyLogBundle\Formatter\EasyLogFormatter(120, 2, $container->parameters['easy_log.ignored_routes']));

        return $container->privates['monolog.handler.buffered'] = new \Monolog\Handler\BufferHandler($a, 0, 'debug', true, false);
    }
    ...
    protected static function getMonolog_LoggerService($container)
    {
        ...
        $instance->pushHandler(($container->privates['monolog.handler.buffered'] ?? self::getMonolog_Handler_BufferedService($container)));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\Extension());
        ...
        $instance->addGlobal('app_name', $container->getEnv('APP_NAME'));
        $instance->addGlobal('app_version', $container->getEnv('APP_VERSION'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'site_urls' => [
                ...
                'esdiario' => 'https://www.esdiario.com/rss/home.xml',
                'cope' => 'https://www.cope.es/api/es/news/rss.xml',
                'antena3' => 'https://www.antena3.com/noticias/rss/4013050.xml',
                'abc' => 'https://www.abc.es/rss/2.0/portada/',
                'lasexta' => 'https://www.lasexta.com/rss/351410.xml',
                ...
                'eleconomista' => 'https://www.eleconomista.es/rss/rss-seleccion-ee.php',
                'elmundo' => 'https://rss.unidadeditorial.es/test_tecnologia/elmundo/allsections_todo_art.xml',
                'marcausa' => 'https://rss.unidadeditorial.es/test_tecnologia/marcausa/allsections_todo_art.xml',
                'marca' => 'https://rss.unidadeditorial.es/test_tecnologia/marca/allsections_todo_art.xml',
                'expansion' => 'https://rss.unidadeditorial.es/test_tecnologia/expansion/allsections_todo_art.xml',
                'hoy' => 'https://www.hoy.es/rss/2.0/portada/',
                'elcorreo' => 'https://www.elcorreo.com/rss/2.0/portada/',
                'eldiariomontanes' => 'https://www.eldiariomontanes.es/rss/2.0/portada/',
            ],
            ...
            'dukecity_command_scheduler.ping_back_provider' => NULL,
            'dukecity_command_scheduler.ping_back' => true,
            'dukecity_command_scheduler.ping_back_failed' => true,
