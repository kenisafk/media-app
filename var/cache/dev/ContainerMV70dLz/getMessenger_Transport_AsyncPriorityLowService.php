...
class getMessenger_Transport_AsyncPriorityLowService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.async_priority_low'])) {
            return $container->privates['messenger.transport.async_priority_low'];
        }

        return $container->privates['messenger.transport.async_priority_low'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN'), ['exchange' => ['name' => 'low'], 'queues' => ['messages_low' => NULL], 'transport_name' => 'async_priority_low'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
