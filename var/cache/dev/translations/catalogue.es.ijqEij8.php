...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'confirm.disable' => 'Es posible que la tarea se esté ejecutando. ¿Estás seguro de que quieres desactivarlo?',
    'action.disable' => 'Desactivar tarea',
    ...
    'flash.execute' => 'El comando "%name%" será ejecutado en el siguiente "scheduler:execute".',
