...
$catalogue = new MessageCatalogue('pt-br', array (
  ...
  array (
    ...
    'confirm.disable' => 'A tarefa pode estar em execução. Tem certeza de que deseja desativá-lo?',
    'action.disable' => 'Desabilitar tarefa',
    ...
    'flash.execute' => 'Comando "%name%" será executado no próximo "scheduler:execute".',
