...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    ...
    'confirm.disable' => 'Mogelijk wordt de taak uitgevoerd. Weet u zeker dat u dit wilt uitschakelen?',
    'action.disable' => 'Schakel taak uit',
    ...
    'flash.execute' => 'Het commando "%name%" zal worden uitgevoerd tijdens de volgende "scheduler:execute".',
