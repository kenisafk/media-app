...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'confirm.disable' => 'La tâche est peut-être en cours d\'exécution. Etes-vous sûr de vouloir le désactiver ?',
    'action.disable' => 'Désactiver la tâche',
    ...
    'detail.nextRun' => 'Prochaine exécution',
    'detail.pingBackUrl' => 'URL de retour (succès)',
    'detail.pingBackFailedUrl' => 'URL de retour (erreur)',
    'detail.notes' => 'Notes',
    'flash.success' => 'Planification sauvegardée avec succés.',
    'flash.deleted' => 'Planification supprimée avec succés.',
    'flash.execute' => 'Le traitement "%name%" sera exécuté lors de la prochaine vérification (scheduler:execute).',
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'confirm.disable' => 'The task may be running. Are you sure you want to disable it ?',
    'action.disable' => 'Disable task',
    ...
    'detail.pingBackUrl' => 'PingBackUrl',
    'detail.pingBackFailedUrl' => 'PingBackFailedUrl',
    'detail.notes' => 'notes',
