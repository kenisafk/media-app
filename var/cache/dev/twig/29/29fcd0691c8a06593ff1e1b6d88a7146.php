...
class __TwigTemplate_d8f42ee4f17c79bda8c75119aa4377ac extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <h1>Edit Document</h1>

    ";
        // line 8
        yield Twig\Extension\CoreExtension::include($this->env, $context, "document/_form.html.twig", ["button_label" => "Update"]);
        yield "
...
{% block body %}
    ...
    <a href=\"{{ path('app_document_index') }}\">back to list</a>

    {{ include('document/_delete_form.html.twig') }}
{% endblock %}
", "document/edit.html.twig", "/var/www/html/templates/document/edit.html.twig");
    }
}
