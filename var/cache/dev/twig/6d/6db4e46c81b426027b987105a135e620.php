...
class __TwigTemplate_fc22fe5664edc07f4e0578e15a4c5352 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <article class=\"bg-gray-200 max-w-4xl mx-auto p-8\">
        <header class=\"mb-8\">
            <h1 class=\"text-3xl font-bold mb-4\">🗞️ ";
        // line 8
...
{% block body %}
    <article class=\"bg-gray-200 max-w-4xl mx-auto p-8\">
        <header class=\"mb-8\">
            <h1 class=\"text-3xl font-bold mb-4\">🗞️ {{ document.title }}</h1>
